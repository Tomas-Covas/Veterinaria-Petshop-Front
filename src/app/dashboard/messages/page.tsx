...
export default function VetMessagesPage() {
    ...
    if (!userData?.user?.id) {
        return (
            <div className="min-h-screen pt-32 flex items-center justify-center bg-linear-to-br from-purple-50 to-violet-50">
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-purple-50 to-violet-50" style={{ paddingTop: '140px', paddingBottom: '48px' }}>
