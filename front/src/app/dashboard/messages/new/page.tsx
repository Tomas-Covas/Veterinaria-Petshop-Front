                        ...
                        {users.length === 0 ? (
                            ...
                            <>
                                ...
                                {users.filter(u => u.role === 'admin').length > 0 && (
                                    <div>
                                        <div className="bg-linear-to-r from-red-500 to-pink-500 px-4 py-2 sticky top-0 z-10">
                                ...
                                {users.filter(u => u.role === 'veterinarian').length > 0 && (
                                    <div>
                                        <div className="bg-linear-to-r from-green-500 to-teal-500 px-4 py-2 sticky top-0 z-10">
                                            <h3 className="text-white font-semibold text-sm flex items-center gap-2">
                                                <span>👨‍⚕️</span>
                                                Colegas Veterinarios
                                            </h3>
                                ...
                                {users.filter(u => u.role === 'user').length > 0 && (
                                    <div>
                                        <div className="bg-linear-to-r from-orange-500 to-amber-500 px-4 py-2 sticky top-0 z-10">
                                            <h3 className="text-white font-semibold text-sm flex items-center gap-2">
                                                <span>🐾</span>
                                                Clientes
                                            </h3>
